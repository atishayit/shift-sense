...
export class ScheduleController {
  ...
  @Get('orgs/:orgRef/schedules')
  list(@Param('orgRef') orgRef: string) {
    return this.svc.list(orgRef);
  }
  ...
  @Get('schedules/:id/summary')
  summary(@Param('id') id: string) {
    return this.svc.summary(id);
  }

  @Get('orgs/:orgRef/preset')
  getPreset(@Param('orgRef') orgRef: string) {
    return this.svc.getPreset(orgRef);
  }

  @Put('orgs/:orgRef/preset')
  @ApiKeyProtected()
  savePreset(@Param('orgRef') orgRef: string, @Body() body: any) {
  ...
  pin(@Param('id') id: string) {
    return this.svc.pinAssignment(id, true);
  }

  @Patch('assignments/:id/unpin')
  @ApiKeyProtected()
  unpin(@Param('id') id: string) {
    return this.svc.pinAssignment(id, false);
  }
